...
const MaternityHospitals = () => {
  return (
    <div className="article-full">
      ...
      <div className="article-section">
        <h3 className="article-section-title">3. Hospital Regional de São José</h3>
        <p className="article-section-info">📍 São José (метрополия Флорианополиса)</p>
        <p className="article-text">
          Обслуживает жителей Флорианополиса и соседних муниципалитетов. 
          Несмотря на большую нагрузку, здесь есть хорошее акушерское отделение и врачи с большим опытом работы.
        </p>
      </div>
